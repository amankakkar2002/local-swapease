...
const Signup = () => {
  ...
  const PostData = async (e) => {
    e.preventDefault();
    const { name, email, enrollment, sector, password, cpassword,course,branch,batch,year,esubject, dsubject} = user;
      ...
      <div className="wrapper3">
        <div className="wrapper4">
          ...
          <form method="POST" id="register-form">
            ...
            <div>
              <img src={logo2} alt="logo2" className="img4"></img>
              <input
                type="email"
                name="email"
                value={user.email}
            ...
            <input type="hidden" name="course" value={user.course} onChange={handleInputs} />
            <input type="hidden" name="branch" value={user.branch} onChange={handleInputs} />
            <input type="hidden" name="batch" value={user.batch} onChange={handleInputs} />
            <input type="hidden" name="year" value={user.year} onChange={handleInputs} />
            <input type="hidden" name="esubject" value={user.esubject} onChange={handleInputs} />
            <input type="hidden" name="dsubject" value={user.dsubject} onChange={handleInputs} />
            <button
              input="true"
              type="submit"
              name="signup"
